...
const client = new Client({
    ...
    database: 'gdb_3036',       // Nombre de la base de datos
...
// Desplegar en un servicio local a través del puerto 3036
app.listen(3036, () => {
    console.log('Servidor ejecutándose en http://localhost:3036');
});